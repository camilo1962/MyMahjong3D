...
public class Tile : MonoBehaviour
{
    ...
    [SerializeField] List<Material> tileTypeMaterial; // ya en el mismo orden que la enumeración
    ...
    //Cubes.shader variable que controla la intensidad de la sombra
    //Esto se cambiará a un valor más alto, haciéndolo más brillante al pasar el mouse.
