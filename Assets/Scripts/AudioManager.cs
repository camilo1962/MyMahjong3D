...
public class AudioManager : MonoBehaviour
{
    ...
    //Music
    private void OnVictory(object sender, EventArgs e) => PlayLoopingMusic("solea");
    private void OnTimeOutGameOver(object sender, EventArgs e) => PlayLoopingMusic("farruca");
    private void OnResumeButtonWasClicked(object sender, EventArgs e) => PlayLoopingMusic("Flamenco");
    private void OnRestartGame(object sender, EventArgs e) => PlayLoopingMusic("Flamenco");
    private void OnPauseButtonWasClicked(object sender, EventArgs e) => PlayLoopingMusic("malaguena");

    //Sound Effects
    private void OnLoadMainScene(object sender, EventArgs e) => PlayLoopingMusic("Flamenco");
